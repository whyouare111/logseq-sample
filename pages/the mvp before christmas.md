...
## **学到了什么？**
###
> 我们了解到，我们真的可以在很短的时间内，努力推动和快速工作，使一个宏伟的目标成为现实。我想我们通过在12月25日的最后期限前完成任务来证明这一点。
###
> 我们还了解了很多关于每个人和我们的能力（我们只有三个人），以及我们需要如何与对方沟通，以建立更多的信任和对事情进展的信心。这包括对代码库和产品的期望和责任、未解决的问题、优先级以及任何特定冲刺的个人目标进行更多的沟通。
###
> 期待不久后有更多关于$WRITE的信息。
#### 个人补充
#####
